...
fun getDateMinutes(year: Int, month: Int, day: Int, minutes: Int, seconds: Int) : Int {
    val calendar = Calendar.getInstance()
    calendar.set(year, month, day, minutes, seconds)
    return calendar.get(Calendar.HOUR_OF_DAY) * 60 + calendar.get(Calendar.MINUTE)
}

fun getCurrentDate() : Calendar = Calendar.getInstance(TimeZone.getDefault())
